...
import com.baldev.eventify.presentation.creategroup.GroupUserListAdapter.UserViewHolder;

import java.util.List;

class GroupUserListAdapter extends RecyclerView.Adapter<UserViewHolder> {
